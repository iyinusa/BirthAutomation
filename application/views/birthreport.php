    <div class="rightside">
        <div class="page-head">
            <h1>Birth Certificate Report</h1>
            <ol class="breadcrumb">
                <li>You are here:</li>
                <li><a href="<?php echo base_url(); ?>">Home</a></li>
                <li>Report</li>
                <li class="active">Birth Report</li>
            </ol>
        </div>
									...
									foreach($allup as $up){
										...
										$dir_list .= '
											<tr>
												...
												<td>'.$centre_name.'</td>
												<td>
													<a href="'.base_url().'birthreport?cert='.$up->id.'" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-search"></i> Certificate</a>
												</td>
											</tr>
										';	
									}
