                ...
                <table width="100%">
                	<tr>
                    	<td width="33%" align="center">
                            ...
                            <div style="font-size:20px; font-weight:bold;">CERTIFICATE OF DEATH     &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;A13.......</div><br />
            ...
            <div class="e_body">
                ...
                <table width="100%" class="rpt">
                    ...
                    <tr>
                        ...
                        <td>
                        	<b>3. Date of Death:</b> <?php echo $e_rec_date; ?> 
                        </td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<b>4. Age of Death:</b> <?php echo $e_m_age; ?> 
                        </td>
                    </tr>
                    <!--<tr>
                    	<td>
                        	<b>4. Place of Death:</b> <?php echo $e_sex; ?> 
                        </td>
                        <td>
                        	<b>Town/Village:</b> <?php echo $e_town; ?> 
                        </td>
                    ...
                    <tr>
                    	<td colspan="2">
                        	<b>5. Address of Usual Place of Residence of Deceased:</b> <?php echo $e_m_address; ?> 
                        </td>
                    </tr>
                    <tr>
                    	<td colspan="2">
                        	<b>6. Full Name of Informant:</b> <?php echo $e_i_fullname; ?> 
                        </td>
                    </tr>
                </table>
